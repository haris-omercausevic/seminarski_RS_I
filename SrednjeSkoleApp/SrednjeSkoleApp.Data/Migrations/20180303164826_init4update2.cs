...
{
    public partial class init4update2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            ***REMOVED***,
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AutorizacijskiToken_Korisnici_KorisnickiNalogId",
            ...
            ***REMOVED***);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UcenikId = table.Column<int>(nullable: false),
                    UcenikId1 = table.Column<int>(nullable: true)
            ***REMOVED***,
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Izostanci_Korisnici_UcenikId1",
                        column: x => x.UcenikId1,
                        principalTable: "Korisnici",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ***REMOVED***);
            ...
            ***REMOVED***,
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UceniciCasovi_Korisnici_UcenikId1",
                        column: x => x.UcenikId1,
                        principalTable: "Korisnici",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
