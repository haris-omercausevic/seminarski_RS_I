...
{
    public partial class Zadatak52 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            ***REMOVED***,
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UceniciRazredi_SkolskaGodina_SkolskaGodinaId",
                        column: x => x.SkolskaGodinaId,
                        principalTable: "SkolskaGodina",
                        principalColumn: "SkolskaGodinaId",
                        onDelete: ReferentialAction.Restrict);
            ...
            ***REMOVED***);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UcenikId = table.Column<int>(nullable: false),
                    UcenikKorisnikId = table.Column<int>(nullable: true)
            ***REMOVED***,
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Izostanci_Korisnici_UcenikKorisnikId",
                        column: x => x.UcenikKorisnikId,
                        principalTable: "Korisnici",
                        principalColumn: "KorisnikId",
                        onDelete: ReferentialAction.Restrict);
            ***REMOVED***);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UcenikCasoviId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CasId = table.Column<int>(nullable: false),
                    CasId1 = table.Column<int>(nullable: true),
                    UcenikId = table.Column<int>(nullable: false),
                    UcenikKorisnikId = table.Column<int>(nullable: true)
            ***REMOVED***,
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UceniciCasovi_Casovi_CasId1",
                        column: x => x.CasId1,
                        principalTable: "Casovi",
                        principalColumn: "CasId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UceniciCasovi_Korisnici_UcenikKorisnikId",
                        column: x => x.UcenikKorisnikId,
                        principalTable: "Korisnici",
                        principalColumn: "KorisnikId",
                        onDelete: ReferentialAction.Restrict);
            ...
            ***REMOVED***,
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ocjene_UceniciPredmeti_UcenikPredmetId",
            ...
            ***REMOVED***);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Izostanci_UcenikKorisnikId",
                table: "Izostanci",
                column: "UcenikKorisnikId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ocjene_UcenikPredmetId",
                table: "Ocjene",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UceniciCasovi_UcenikKorisnikId",
                table: "UceniciCasovi",
                column: "UcenikKorisnikId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UceniciRazredi_SkolskaGodinaId",
                table: "UceniciRazredi",
                column: "SkolskaGodinaId");
